...
function TaskPanel({ visibleTasks, filterCounts, activeFilter, remainingCount, completedCount, onFilterChange, onToggleTask, onEditTask, onDeleteTask, onClearCompleted }) {
  return (
    <section className="task-panel" aria-labelledby="task-list-heading">
      ...
      <TaskFilters activeFilter={activeFilter} counts={filterCounts} onChange={onFilterChange} />
